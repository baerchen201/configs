...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(990000ee)", "rgba(ff3300ee)"}, angle = 45 },
...
hl.config({
    input = {
        ...
        scroll_button = 274, -- Middle mouse button
    },
})
...
hl.bind("PAUSE", hl.dsp.exec_cmd("mumble rpc togglemute"))
